...
p {
   ...
   <div class="ta">
	   ...
	   <h2 class =" heading">Edit Seller Information</h2>
			<form action="updateseller.php" method="POST">
	<div class="a">
	<p>Seller ID<br>
	<input type="number" name="seller_id" value="<?php print $_GET['Seller_ID'];?>" style="text-align:center;opacity:0.8;"readonly/>
	<p>Seller Name<br>
		<input type="text" name="seller_name" value=""></p>
	<p>Designation<br>
