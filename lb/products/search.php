...
<table style="width:80%">
  <tr style="color:blue">
    <center>
    <h1 style="margin: 16% 0%">Product Information</h1></center>
    <th>Product_ID</th>
    <th>Product_Name</th> 
    <th>Quantity</th>
    <th>Price</th>
...
<?php
  ...
  $SQL = "SELECT * FROM `tb_products` WHERE '".$searchKeyword."' IN (Product_ID,Product_Name,Quantity,Price,Validity,VAT,Total_Price);";
