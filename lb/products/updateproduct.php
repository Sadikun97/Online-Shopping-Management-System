...
.heading {
   ...
   <div class="ta">
	   ...
	   <h2 class =" heading">Update Product Information</h2>
	<div class="toast">
		<?php
...
$sql="UPDATE tb_products SET Product_Name = '".$_POST['product_name']."', Quantity ='".$_POST['quantity']."', Price ='".$_POST['price']."', Validity ='".$_POST['validity']."', VAT ='".$_POST['vat']."', Total_Price ='".$_POST['total_price']."' WHERE Product_ID = '".$_POST['product_id']."'";
