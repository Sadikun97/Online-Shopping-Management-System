...
<html>
   <head>
    ...
    color: black;}
		 ...
		 body{
    background-color: #dcefff;		color:black;	
	font-family:Arial;
...
(Product_ID,Product_Name,Quantity,Price,Validity,VAT,Total_Price)
VALUES('$_POST[product_id]','$_POST[product_name]','$_POST[quantity]','$_POST[price]','$_POST[validity]','$_POST[vat]','$_POST[total_price]')" ;
