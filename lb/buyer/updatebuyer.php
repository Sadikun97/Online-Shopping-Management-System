...
.heading {
   ...
   <div class="ta">
	   ...
	   <h2 class =" heading">Update Buyer Information</h2>
	<div class="toast">
		<?php
...
$sql="UPDATE tb_buyer SET Buyer_Name = '".$_POST['buyer_name']."', Address ='".$_POST['address']."', Contact ='".$_POST['contact']."', Mail_ID ='".$_POST['mail_id']."' WHERE Buyer_ID = '".$_POST['buyer_id']."'";
