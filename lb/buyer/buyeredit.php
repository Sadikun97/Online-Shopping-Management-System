...
p {
   ...
   <div class="ta">
	   ...
	   <h2 class =" heading">Edit Buyer Information</h2>
			<form action="updatebuyer.php" method="POST">
	<div class="a">
	<p>Buyer ID<br>
	<input type="number" name="buyer_id" value="<?php print $_GET['Buyer_ID'];?>" style="text-align:center;opacity:0.8;"readonly/>
	<p>Buyer Name<br>
		<input type="text" name="buyer_name" value=""></p>
	<p>Address<br>
		<input type="text" name="address" value=""></p>
	<p>Contact<br>
		<input type="text" name="contact" value=""></p>
	<p>Mail_ID<br>
		<input type="text" name="mail_id" value=""></p>
